...
void ggml_compute_forward_rope_pe(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_conv_2d_deform(struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_conv_1d_direct(const struct ggml_compute_params * params, struct ggml_tensor * dst);
